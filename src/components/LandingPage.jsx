...
function LandingPage({ triggerAnimation }) {
    ...
    <div className="landing-page-container">
      ...
      <div className="landing-page">
        ...
        <div className="starting-page">
          <img className="logo-landing" alt="skoolhub logo" src={skoolhublogo} />
        </div>
        <button className="scroll-down" type="button" onClick={scrollToSnippContainer1}>↓ Learn More ↓</button>
      </div>
